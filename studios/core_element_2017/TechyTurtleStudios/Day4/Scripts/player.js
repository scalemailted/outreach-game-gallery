...
player.image.src = "Assets/slime right0.png";
player.health = 100;
player.speed = 4;
player.velX = 0;                    
player.velY = 0;                    
...
player.poses['left'] = new Animation(["Assets/slime right0.png", "Assets/slime right1.png", "Assets/slime right2.png" ])
player.poses['right'] = new Animation(["Assets/Slime/slime left0.png", "Assets/Slime/slime left1.png", "Assets/Slime/slime left2.png"]);
player.poses['front'] = new Animation(["Assets/slime0.png"]);
player.poses['jump'] = new Animation (["Assets/jump/slime jumping0.png", "Assets/jump/slime jumping1.png", "Assets/jump/slime jumping2.png"])
