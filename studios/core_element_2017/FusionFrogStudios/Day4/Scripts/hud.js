hud = new Object();
hud.gameOverImage = new Image();
hud.gameOverImage.src = "Assets/Fusion_Frogs_GameOver.png"
...
hud.drawGameOver = function()
{
	...
	renderer.ctx.drawImage(hud.gameOverImage, 0, 0, viewport.width, viewport.height);
};
