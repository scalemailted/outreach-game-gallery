...
player.image.src = "Assets/sprite_Timothy0.png";
player.health = 100;
player.speed = 4;
player.velX = 0;                    
player.velY = 0;                    
...
player.poses = {};
player.poses["right"] = new Animation(["Assets/Fusion_Frogs_Timothy_goin'_fast..1.png"]);
player.poses["left"] = new Animation(["Assets/sprite_Timothy0.png"]);
