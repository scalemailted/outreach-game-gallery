...
player.image.src = "Assets/woodman.png";
player.health = 100;
player.speed = 4;
player.velX = 0;                    
player.velY = 0;                    
...
player.poses = {};
player.poses['right'] = new Animation (["Assets/woodman_walk_right0.png", "Assets/woodman_walk_right1.png" ])
player.poses['left'] = new Animation (["Assets/woodman_walkleft0.png", "Assets/woodman_walkleft1.png" ])
player.poses['front'] = new Animation (["Assets/woodman.png"])
