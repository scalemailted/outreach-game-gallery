...
player.image.src = "GG assets/GG New Character.png";
player.health = 100;
player.speed = 4;
player.velX = 0;                    
player.velY = 0;                    
...
player.poses = {};
player.poses['right']= new Animation(['GG assets/GG New Character Walking Right/sprite_0.png', 'GG assets/GG New Character Walking Right/sprite_1.png']);
player.poses['left']= new Animation(['GG assets/GG New Character Walking Left/sprite_0.png', 'GG assets/GG New Character Walking Left/sprite_1.png']);
player.poses['front'] =  new Animation(['GG assets/GG New Character.png']);
