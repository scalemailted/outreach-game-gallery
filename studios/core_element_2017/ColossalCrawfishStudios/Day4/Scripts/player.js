...
player.poses = {};
player.poses["right"] = new Animation(["Assets/character.png"]);
player.poses["left"] = new Animation(["Assets/character.png"]);
player.poses['front'] = new Animation(["Assets/character.png"]);
...
player.move = function(x, y)
{
    ...
    { 
        ...
        player.velY = -player.speed*2;
         var audio=new Audio ("Assets/sfx_sound_bling_wav");
        audio.play() 
    }
