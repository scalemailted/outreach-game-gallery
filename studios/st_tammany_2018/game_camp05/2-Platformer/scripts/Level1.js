class Level1 extends Phaser.Scene
{
    ...
    preload()
    {
        ...
        playersize.frameWidth = 64;
        playersize.frameHeight = 64;
    ...
    setup_physics()
    {
        ...
        this.physics.add.overlap(this.player, this.group_collectables, this.Gears_take, null, this);
    ...
    setup_camera()
    {
        ...
        this.cameras.main.setBackgroundColor('rgb(200,255,200)');
    }
    ...
    create_objects()
    {
        ...
        this.group_hazard1 = this.map.createFromObjects('items' ,'FloorSpikes' ,hazard1_image);
        this.setup_objects(this.group_hazard1);
        
        var hazard2_image = new Object();
        hazard2_image.key = 'itemMap';
        hazard2_image.frame = 4;
        this.group_hazard2 = this.map.createFromObjects('items' ,'RoofSpikes' ,hazard2_image);
        this.setup_objects(this.group_hazard2);
        
        var collect_image = new Object();
        collect_image.key = 'itemMap';
        collect_image.frame = 5;
        this.group_collectables = this.map.createFromObjects('items', 'Gears' ,collect_image);
        this.setup_objects(this.group_collectables);
        
        var goal_image = new Object();
        goal_image.key = 'itemMap'
        goal_image.frame = 0
        this.goal = this.map.createFromObjects('items' ,'PortalEnd', goal_image);
