class Level1 extends Phaser.Scene
{
  ...
  create_objects()
  {
    ...
    hazard3_image.frame = 5;
    this.group_hazard3 = this.map.createFromObjects('items','spikes-left', hazard3_image);
    this.setup_objects(this.group_hazard3);
    
     var hazard4_image = new Object();
    hazard4_image.key = 'itemMap';
    hazard4_image.frame = 6;
    this.group_hazard4 = this.map.createFromObjects('items','spikes-right', hazard4_image);
    this.setup_objects(this.group_hazard4);
    
    var falling_image = new Object();
    falling_image.key = 'tileMap';
    falling_image.frame = 9;
    this.group_falling = this.map.createFromObjects('items', 'falling block', falling_image);
