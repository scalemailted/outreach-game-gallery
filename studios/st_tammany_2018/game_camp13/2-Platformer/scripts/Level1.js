class Level1 extends Phaser.Scene
{
    ...
    preload()
    {
        ...
        size.frameWidth = 32;
        size.frameHeight = 32;
        this.load.spritesheet('player', 'player1.png',size);
    ...
    setup_physics()
    {
        ...
        this.physics.add.overlap(this.player, this.group_collectables, this.gem_take, null, this);
    ...
    setup_camera()
    {
        ...
        this.cameras.main.setBackgroundColor('rgb(140,120,255)');
    }
    ...
    create_objects()
    {
        ...
        this.group_hazard3 = this.map.createFromObjects('items', 'meteor', hazard3_image);
        this.setup_objects(this.group_hazard3);
        
        var collect_image = new Object();
        collect_image.key = 'itemMap';
        collect_image.frame = 4;
        this.group_collectables = this.map.createFromObjects('items', 'gem', collect_image);
