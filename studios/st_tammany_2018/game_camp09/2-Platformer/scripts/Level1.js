class Level1 extends Phaser.Scene
{
    ...
    setup_camera()
    {
        ...
        this.cameras.main.setBackgroundColor('rgb(0,120,255)');
    }
    ...
    create_objects()
    {
       ...
       this.group_hazard1 = this.map.createFromObjects('items','spike up', hazard1_image);
       this.setup_objects(this.group_hazard1);
    
        var hazard2_image = new Object();
        hazard2_image.key = 'itemMap';
        hazard2_image.frame = 1;
        this.group_hazard2 = this.map.createFromObjects('items','spike down', hazard2_image);
        this.setup_objects(this.group_hazard2);
        
        var collect_image = new Object();
        collect_image.key = 'itemMap';
        collect_image.frame = 2;
        this.group_collectables = this.map.createFromObjects('items','diamond',collect_image);
