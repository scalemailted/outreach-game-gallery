...
player.image.src = "Assets/righty0.png";
player.health = 100;
player.speed = 4;
player.velX = 0;                    
player.velY = 0;                    
...
player.poses = {};
player.poses['right'] = new Animation( ['Assets/righty0.png','Assets/righty1.png']);
player.poses['left'] = new Animation( ['Assets/lefty0.png','Assets/lefty1.png']);
