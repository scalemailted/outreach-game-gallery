...
player.image.src = "Assets/kylo0.png";
player.health = 100;
player.speed = 4;
player.velX = 0;                    
player.velY = 0;                    
...
player.poses = {};
player.poses['right'] = new Animation( ['Assets/kylo0.png','Assets/kylo1.png']);
player.poses['left'] = new Animation( ['Assets/kyloleft0.png','Assets/kyloleft1.png']);
