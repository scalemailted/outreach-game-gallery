class Level1 extends Phaser.Scene
{
    ...
    preload()
    {
        ...
        let size = {frameWidth:64 , frameHeight: 64};
    ...
    setup_camera()
    {
        ...
        this.cameras.main.setBackgroundColor('rgb(103,141,255)');
    }
   ...
   setup_object( objGroup)
    ...
    create_objects()
    {
        ...
        let spike_image = {key: 'itemMap', frame: 1};
        this.group_hazards = this.map.createFromObjects('items', 'spike',spike_image);
        this.setup_object(this.group_hazards);
    }
